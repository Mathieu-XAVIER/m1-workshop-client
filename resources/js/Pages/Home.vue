        ...
        <div class="main-wrapper">
            ...
            <div class="categories-grid">
                ...
                <div v-for="(subject, index) in uniqueSubjects" :key="subject"
                     class="category-card"
                     :class="getQuizzClass(index)"
                     @click="goToQuizz(subject)">
                    <!-- Icon Container -->
                    <div class="category-icon" :class="getQuizzClass(index)">
                    ...
                    <button class="category-button" :class="getQuizzClass(index)">
...
// Classes CSS pour alterner les styles de quizz
const quizzClasses = ['math', 'french', 'computer']
...
const getQuizzClass = (index) => {
    return quizzClasses[index % quizzClasses.length]
}
